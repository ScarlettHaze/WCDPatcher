                    ...
                    case "-desclang":
                        {
                            ...
                            if (argv.Length >= (i + 1))
                            {
                                switch (argv[i + 1])
                                {
                                    ...
                                    case "English": { _desc_offset = Core.DistroPatcher.DistroOffsets.DescriptionOffsets.eng_desc; break; }
                                    case "German": { _desc_offset = Core.DistroPatcher.DistroOffsets.DescriptionOffsets.ger_desc; break; }
                                    case "French": { _desc_offset = Core.DistroPatcher.DistroOffsets.DescriptionOffsets.frn_desc; break; }
                                    case "Italian": { _desc_offset = Core.DistroPatcher.DistroOffsets.DescriptionOffsets.ita_desc; break; }
                                    case "Spanish": { _desc_offset = Core.DistroPatcher.DistroOffsets.DescriptionOffsets.spn_desc; break; }
                                    case "Japanese": { _desc_offset = Core.DistroPatcher.DistroOffsets.DescriptionOffsets.jap_desc; break; }
                                    case "Korean": { _desc_offset = Core.DistroPatcher.DistroOffsets.DescriptionOffsets.eng_desc; break; }
                    ...
                    case "-dodirdef":
                        {
                            ...
                            if (System.IO.Directory.Exists(dir))
                            {
                                ...
                                if (_region == null) { _region = "English"; }
