    ...
    public static class DistroPatcher
    {
           ...
           string gameALRegion, string Desc, int friendDistLimit, int randomSeed)
        {
            ...
            switch (Region.ToLower())
            {
                ...
                case "english": ggid_data = Core.WondercardPatcher.WondercardData.GGID_English; break;
                case "japanese": ggid_data = Core.WondercardPatcher.WondercardData.GGID_Japanese; break;
                case "spanish": ggid_data = Core.WondercardPatcher.WondercardData.GGID_Spanish; break;
                case "korean": ggid_data = Core.WondercardPatcher.WondercardData.GGID_Korean; break;
                case "italian": ggid_data = Core.WondercardPatcher.WondercardData.GGID_Italian; break;
                case "german": ggid_data = Core.WondercardPatcher.WondercardData.GGID_German; break;
                case "french": ggid_data = Core.WondercardPatcher.WondercardData.GGID_French; break;
