...
namespace WCDPatcher
{
    public static class BatchProcessing
    {
        ...
        public static bool DoWonderCardFolder(bool Recursive, string Folder, GUI.GUI options)
        {
            ...
            System.Windows.Forms.MessageBox.Show("Batch operations completed\n" + successFiles.ToString() + "/" + i.ToString() + " files successfully patched"
                , "Completed", System.Windows.Forms.MessageBoxButtons.OK, System.Windows.Forms.MessageBoxIcon.Question, System.Windows.Forms.MessageBoxDefaultButton.Button1);
